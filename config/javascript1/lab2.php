...
"text" => <<<EOD
Create a function called 'productNumbers()'. The function should take three arguments and return the product of them. Try the function using the numbers $num1, $num2 and $num3.  
...
"text" => <<<EOD
Create a function 'stringPhrase()' that returns a phrase. Your word is '$color'. Pass the word as an argument to the function and the returned phrase should be: 'My favorite color is $color.'.  
